...
const ListaInvitados = ({ titulo }) => {
    ...
    const result = await axios.get('http://www.goweddings.net:3000/admin/lista-invitados');
    ...
    const guardarInvitado = async ( obj, dato )=>{
        if(dato == 'grupo'){
            const result = await axios.put(`http://www.goweddings.net:3000/admin/lista-invitados/grupo/${obj.id}`, obj );
        }else{
            const result = await axios.put(`http://www.goweddings.net:3000/admin/lista-invitados/mesa/${obj.id}`,obj);
        }
